...
[![Build Status](https://travis-ci.org/AndroidBootstrap/br-com-mobiclub-saobraz.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/br-com-mobiclub-saobraz)

This repository contains the source code for the [MobiClub](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=br.com.mobiclub.saobraz).

Please see the [issues](https://github.br.com.mobiclub.saobraz/br-com-mobiclub-saobraz/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about MobiClub? Ask away on the [br-com-mobiclub-saobraz discussion forum](https://groups.google.com/forum/#!forum/br-com-mobiclub-saobraz).

<a href="https://play.google.com/store/apps/details?id=br.com.mobiclub.saobraz" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __br.com.mobiclub.fastfood__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____br.com.mobiclub.fastfood__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.br.com.mobiclub.saobraz.R__) will now be renamed
...
signed with a different key.  Manually uninstall MobiClub from your device and
...
MobiClub is a result of a template project I've developed over the years as well as
...
MobiClub is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.br.com.mobiclub.saobraz/br-com-mobiclub-saobraz/contributors) on
...
[pull requests](https://github.br.com.mobiclub.saobraz/br-com-mobiclub-saobraz/pulls).
