...
import static br.com.mobiclub.quantoprima.ui.activity.account.AccountActivity.PARAM_AUTHTOKEN_TYPE;

class MobiClubAccountAuthenticator extends AbstractAccountAuthenticator {

    private static final String DESCRIPTION_CLIENT = "Bootstrap for Android";

    private final Context context;

    public MobiClubAccountAuthenticator(final Context context) {
        super(context);
    ...
    public Bundle addAccount(final AccountAuthenticatorResponse response, final String accountType,
        ...
        final Intent intent = new Intent(context, SigninEmailActivity.class);
     ...
     * {@link br.com.mobiclub.quantoprima.service.authenticator.ApiKeyProvider#getAuthKey()}
    ...
    public Bundle getAuthToken(final AccountAuthenticatorResponse response,
        ...
        bundle.putString(KEY_ACCOUNT_TYPE, ConstantsApi.Auth.BOOTSTRAP_ACCOUNT_TYPE);
    ...
    public String getAuthTokenLabel(final String authTokenType) {
        return authTokenType.equals(ConstantsApi.Auth.AUTHTOKEN_TYPE) ? authTokenType : null;
    }
