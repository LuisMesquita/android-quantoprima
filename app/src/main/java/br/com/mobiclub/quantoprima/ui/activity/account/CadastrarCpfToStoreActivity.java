...
public class CadastrarCpfToStoreActivity extends ActionBarActivity implements AuthenticationListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cadastrar_to_store_cpf);
        ...
        edtCpf = (EditText) findViewById(R.id.edt_store_cpf);

        edtCpf.addTextChangedListener(Mask.insert("###.###.###-##", edtCpf));

        activity = this;

        //helper = new SignupHelper(this, null, null, null, true);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuInflater inflater = getMenuInflater();
        inflater.inflate(R.menu.account_central, menu);
    ...
    public void onCadastrarCpf(View view){
        if (MobiClubApplication.mobiUser!=null){
            ...
            if(user != null) {
                ...
                String cpfUser = edtCpf.getText().toString();
                authUser(idUser, cpfUser);
            }
        }
    }
        ...
        new SafeAsyncTask<User>() {
            ...
            public User call() throws Exception {
                ...
                if (serviceProvider != null) {
                    ...
                    Log.e("authUser", "serviceProvider can't be null");

                    String msg = getString(R.string.cadastrar_cpf_to_store_service_provider_null);
                    AlertDialogFactory.createDefaultError(CadastrarCpfToStoreActivity.this, msg).show();
                }
            ...
            protected void onSuccess(User user) throws Exception {
                ...
                if(user != null) {
                    if (user.getHttpStatus()==400){
                        AlertDialogFactory.createDefaultError(CadastrarCpfToStoreActivity.this, user.getMessage()).show();
                    }else{
