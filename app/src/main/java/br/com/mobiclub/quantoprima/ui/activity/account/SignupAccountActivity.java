 ...
 *
 */
public abstract class SignupAccountActivity extends ActionBarActivity {
    /**
    ...
    public void onNetworkErrorEvent(NetworkErrorEvent e) {
        ...
        AlertDialogFactory.createDefaultError(SignupAccountActivity.this,
    ...
    public void onAuthenticationResult(final boolean result) {
        if (result) {
            ...
            if (requestNewAccount) {
                Toaster.showLong(SignupAccountActivity.this,
