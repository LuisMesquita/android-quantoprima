...
package br.com.mobiclub.quantoprima.ui.activity.qrcode;
...
import br.com.mobiclub.quantoprima.ui.activity.MobiClubFragmentActivity;
import br.com.mobiclub.quantoprima.ui.activity.qrcode.history.HistoryActivity;
 ...
 * @author Sean Owen
 */
public final class CaptureActivity extends MobiClubFragmentActivity
        implements SurfaceHolder.Callback, DialogListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        online = getIntent().getBooleanExtra(Constants.Extra.QRCODE_READ_TYPE, false);
        ...
        if(titleTextView != null) {
            titleTextView.setTextColor(getResources().getColor(br.com.mobiclub.quantoprima.R.color.black));
            Typeface font = Typeface.createFromAsset(getAssets(), "fonts/bold.ttf");
            titleTextView.setTypeface(font);
        }

        status = (TextView) findViewById(br.com.mobiclub.quantoprima.R.id.label_connection_status);
    ...
    public int getLayout() {
        return br.com.mobiclub.quantoprima.R.layout.capture;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.menu_share) {
            ...
            Intent parentActivityIntent = Facade.getInstance().getParent();
    ...
    private void handleDecodeInternally(Result rawResult, ResultHandler resultHandler, Bitmap barcode) {
        ...
        //achar uma maneira de melhorar isso
        Facade.getInstance().removeLastIntent();
        Intent i = new Intent();
        i.putExtra(Constants.Extra.QR_CODE, displayContents);
    ...
    private void handleDecodeExternally(Result rawResult, ResultHandler resultHandler, Bitmap barcode) {
        ...
        if (source == IntentSource.NATIVE_APP_INTENT) {
            ...
            sendReplyMessage(com.google.zxing.client.android.R.id.launch_product_query, replyURL, resultDurationMS);
