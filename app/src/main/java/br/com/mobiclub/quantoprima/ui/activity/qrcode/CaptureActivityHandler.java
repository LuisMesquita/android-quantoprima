...
public final class CaptureActivityHandler extends Handler {
  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      case com.google.zxing.client.android.R.id.restart_preview:
        restartPreviewAndDecode();
        break;
      ...
      case com.google.zxing.client.android.R.id.decode_failed:
        ...
        break;
      case com.google.zxing.client.android.R.id.return_scan_result:
        activity.setResult(Activity.RESULT_OK, (Intent) message.obj);
        activity.finish();
        break;
      case com.google.zxing.client.android.R.id.launch_product_query:
